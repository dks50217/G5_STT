...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.chbxOpenOutputFilesAuto.setChecked(False)
    ...
    def retranslateUi(self, window):
        ...
        window.setWindowTitle(_translate("window", "pyTranscriberSTT"))
        #window.setMinimumSize()
        self.bSelectMedia.setText(_translate("window", "選擇檔案(可多檔)"))
        self.bConvert.setText(_translate("window", "轉換音檔 / 產生字幕"))
        self.bOpenOutputFolder.setText(_translate("window", "打開輸出資料夾"))
        self.bSelectOutputFolder.setText(_translate("window", "輸出資料夾"))
        self.groupBox.setTitle(_translate("window", "音檔清單"))
        self.bRemoveFile.setText(_translate("window", "移除檔案"))
        self.bCancel.setText(_translate("window", "取消"))
        self.chbxOpenOutputFilesAuto.setText(_translate("window", "輸出完成自動打開輸出資料夾"))
        self.labelSelectLang.setText(_translate("window", "音檔語言:"))
        self.menuAbout.setTitle(_translate("window", "Abo&ut"))
        self.actionLicense.setText(_translate("window", "&License"))
        self.actionAbout_pyTranscriber.setText(_translate("window", "&關於 pyTranscriber"))
