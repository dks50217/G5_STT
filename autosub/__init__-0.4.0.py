...
class FLACConverter(object): # pylint: disable=too-few-public-methods
    ...
    def __init__(self, source_path, include_before=0.25, include_after=0.25):
        ...
        self.logger.logInfo("FLACConverter __INIT__")

    def __call__(self, region):
        self.logger.logInfo("FLACConverter __call__")
        ...
        try:
            ...
            self.logger.logError("FLACConverter KeyboardInterrupt")
            return None
...
class SpeechRecognizer(object): # pylint: disable=too-few-public-methods
    ...
    def __init__(self, language="en", rate=44100, retries=3, api_key=GOOGLE_SPEECH_API_KEY):
        ...
        self.logger = Ctr_Logger()
        self.logger.logInfo("SpeechRecognizer __INIT__")

    def __call__(self, data):
        try:
            self.logger.logInfo("SpeechRecognizer __call__ Start")
            ...
            self.logger.logError("SpeechRecognizer KeyboardInterrupt")
            return None
